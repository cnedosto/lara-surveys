  ...
  <nav class="flex flex-1 flex-col">
    <ul role="list" class="flex flex-1 flex-col gap-y-7">
      ...
      <li class="-mx-6 mt-auto">
        <div x-show="open" x-cloak class="m-4">
        ...
        <div @click.outside="open = false" @click="open = true" href="#" class="flex items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-white hover:bg-gray-800">
