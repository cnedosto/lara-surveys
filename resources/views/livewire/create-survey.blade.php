<div>
    <h2 class="text-4xl font-semibold leading-9 mb-6 text-center">Create a survey</h2>
    <form wire:submit.prevent="submit">
        <x-form-input wire:model="name" label="Survey name" :required="true" class="col-span-6 sm:col-span-3 mt-2"/>
